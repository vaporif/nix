...
Workflow:
1. Measure current state (establish baselines)
2. Profile applications and identify bottlenecks
3. Implement targeted optimizations
4. Validate improvements with benchmarks
5. Monitor impact in production
6. Document changes and decisions

Always prioritize "measure before optimizing" methodology, user experience, system efficiency, and cost optimization while achieving performance targets through systematic measurement.
